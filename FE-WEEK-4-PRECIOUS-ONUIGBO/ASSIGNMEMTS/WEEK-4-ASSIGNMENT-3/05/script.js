...
const handleKeyDown = (event) => {
  ...
  // remember that top is positive like top = 100px moves the top downward that why position.top is plus from steps. so that it goes downwards
  ...
  // remember that left is positive like left = 100px moves the left rightwards that why position.left is plus from steps. so that it goes rightwards
